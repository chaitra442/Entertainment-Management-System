...
(1, 'Photography', 100, 0, 'images/crypto.png', 1),
(2, 'Art', 50, 2, 'images/search_it.jpg', 1),
(3, 'Quiz', 50, 2, 'images/quiz.png', 1),
(4, 'Fancy Dress', 50, 1, 'images/coding.jpg', 1),
(5, 'JAM', 50, 1, 'images/pubg.jpg', 2),
(6, 'Debate', 100, 1, 'images/counter.jpg', 2),
(7, 'Fashion-Show', 200, 1, 'images/onstage.jpg', 3),
(8, 'Dance', 100, 0, 'images/dance.jpg', 3),
(9, 'Singing', 50, 0, 'images/sing.jpg', 3),
(10, 'Battle of Band', 100, 0, 'images/idol.jpg', 3),
...
('1VA17CS005', 'Anu', 'CSE', 5, 'annapoornaba@gmail.com', '8123300011', 'Srinivas'),
('1VA17CS012', 'BHAVANA', 'cse', 5, 'BHAVANA@GMAIL.COM', '9934736623', 'Srinivas'),
('1VA17CS022', 'Kavya', 'cse', 5, 'Kavya@gmail.com', '7888387323', 'Srinivas'),
('1VA17CS025', 'Mythri', 'ISE', 5, 'mythri@saividya.ac.in', '8998848488', 'Srinivas'),
('1VA17CS034', 'Prajwal', 'cse', 5, 'prajwal@gmail.com', '9858787438', 'Srinivas'),
('1VA17IS045', 'Prathiksha', 'ISE', 5, 'prathi@gmail.com', '7897854345', 'Srinivas');
...
CREATE PROCEDURE CalculateNewRegistrations()
BEGIN
    DECLARE totalRegistrations INT;
    
    -- Count the number of rows in the participent table
    SELECT COUNT(*) INTO totalRegistrations FROM participent;
    
    -- Return the total number of newly registered members
    SELECT totalRegistrations;
END//
